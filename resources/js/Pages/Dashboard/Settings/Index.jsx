                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 overflow-hidden shadow-sm">
                        <div className="p-5 border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/50">
                            <h2 className="text-base font-bold text-slate-800 dark:text-slate-100 flex items-center gap-2">
                                <IconCoin className="text-slate-700" size={20} />
                        ...
                        <div className="p-6 space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className={`w-full h-12 pl-12 pr-4 rounded-xl border transition-all focus:ring-2 focus:ring-primary-500 outline-none dark:bg-slate-950 dark:text-white ${
                                                errors.loyalty_point_rate ? 'border-red-500 bg-slate-100' : 'border-slate-200 dark:border-slate-700'
                                            }`}
                                        />
                                    </div>
                                    {errors.loyalty_point_rate && <p className="mt-1 text-xs text-slate-700 font-medium">{errors.loyalty_point_rate}</p>}
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            className={`w-full h-12 px-4 rounded-xl border transition-all focus:ring-2 focus:ring-primary-500 outline-none dark:bg-slate-950 dark:text-white ${
                                                errors.loyalty_reward_threshold ? 'border-red-500 bg-slate-100' : 'border-slate-200 dark:border-slate-700'
                                            }`}
                                        />
                                    ...
                                    {errors.loyalty_reward_threshold && <p className="mt-1 text-xs text-slate-700 font-medium">{errors.loyalty_reward_threshold}</p>}
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className={`w-full px-4 py-3 rounded-xl border transition-all focus:ring-2 focus:ring-primary-500 outline-none dark:bg-slate-950 dark:text-white resize-none ${
                                        errors.loyalty_reward_description ? 'border-red-500 bg-slate-100' : 'border-slate-200 dark:border-slate-700'
                                    }`}
                                    placeholder="Contoh: Free parfum P30 EDT + Botol"
                                />
                                {errors.loyalty_reward_description && <p className="mt-1 text-xs text-slate-700 font-medium">{errors.loyalty_reward_description}</p>}
                            </div>
                            ...
                            <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800">
                                ...
                                <div className="space-y-4">
                                    <p className="text-xs text-slate-500 leading-relaxed">
                                        ...
                                        Setelah mengumpulkan <span className="font-bold text-slate-800 dark:text-slate-200">{data.loyalty_reward_threshold} Poin</span>, member berhak mendapatkan <span className="font-bold text-slate-700 dark:text-slate-300">{data.loyalty_reward_description}</span>.
                                    </p>
