...
// ---------------------------------------------------------------------------
export default function Create({ intensities, sizes }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route("intensity-size-prices.store"), {
            onSuccess: () => {
            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                ...
                <div className="mb-6">
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
                        Tetapkan harga untuk kombinasi intensitas dan ukuran
                    </p>
                </div>
                ...
                <form onSubmit={submit} className="space-y-6">
                        ...
                        <div className="flex gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-amber-700 dark:text-amber-300">
                                    Setiap kombinasi intensitas + ukuran hanya dapat memiliki <strong>satu harga aktif</strong>.
                                    Harga yang dinonaktifkan tidak akan tampil ke pelanggan.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row justify-end gap-3">
                        ...
                        >
                            ...
                            <span>{processing ? "Menyimpan..." : "Simpan Harga"}</span>
                        </button>
                    </div>
                </form>
            </div>
