...
import {
    ...
    IconChartPie, IconClockHour4, IconTrashOff,
    ...
    return (
        <>
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
                ...
                <div className="flex gap-2 w-full md:w-auto">
                    <Link
                        ...
                        className="flex-1 md:flex-none flex items-center justify-center gap-2 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 px-4 py-2 rounded-xl text-sm font-bold hover:bg-slate-200 dark:hover:bg-slate-700 transition-all"
                        title="Pelanggan yang sudah dihapus"
                    >
                        <IconTrashOff size={18} /> Sampah
                    </Link>
                    <a
            ...
            <ConfirmDialog
                ...
                description={
                    <>Pelanggan <strong className="text-slate-700 dark:text-slate-200">{deleteTarget?.name}</strong> akan dipindahkan ke Sampah dan tidak muncul di daftar aktif. Masih bisa dipulihkan lewat menu Sampah.</>
                }
