        ...
        // ─── Penjualan ────────────────────────────────────────────────────────
        {
            ...
            details: [
                ...
                },
                {
                    ...
                    subdetails: [
                        ...
                        },
                        {
                            ...
                            permissions: hasAnyPermission(["sales-people-productivity-access"]),
                        }
                    ]
                },
                {
                ...
                },
                {
                    ...
                    permissions: hasAnyPermission(["reward-items-access"]),
                },
            ],
        },
            ...
            details: [
                {
                    ...
                    permissions: hasAnyPermission(["transactions-history-access"]),
                },
                {
                    title: "Histori Shift",
                    ...
                    icon: <IconCash size={20} strokeWidth={1.5} />,
                    permissions: hasAnyPermission(["cash-drawers-access"]),
                },
            ],
        },
        ...
        // ─── Laporan ──────────────────────────────────────────────────────────
        {
            ...
            details: [
                ...
                },
                {
                    ...
                    icon: <IconHistory size={20} strokeWidth={1.5} />,
                    permissions: hasAnyPermission(["laporan-mutasi-access"]),
                },
            ],
        },
